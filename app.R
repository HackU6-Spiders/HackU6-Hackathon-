...
claimedOnYelp <- "No"
if(sample$is_claimed_yelp){
  claimedOnYelp <- "Yes"  
}

sample$label1 <- paste("<p><span><strong><a href=\"",(sample$website),"\"><span>",sample$name,"</span></a></strong></span></p>")
sample$label2 <- paste("<p><span ><strong><a href=\"",(sample$website),"\"><span>",sample$name,
                       "</span></a></strong></span></p>
                       <p><span><strong><a href=\"",(sample$google_url),"\"><span>Google Review:</span></a></strong></span>",
                       sample$google_rating,"</p>
                       <p>Claimed on Google: Yes </p>
                       <p>Google Review Counts:",sample$google_reviews_count,"</p>
                       <p><span><strong><a href=\"",(sample$yelp_url),"\"><span>Yelp Review:</span></a></strong></span>",
                       sample$yelp_rating,"</p>
                       <p>Yelp Review Counts:",sample$yelp_review_count,"</p>
                       <p>Claimed on Yelp:",claimedOnYelp,"</p>
                       <p>Address:",sample$address,"</p>",
                       "<p>Opening hours:",sample$opening_hours,"</p>",
                       "<p>Phone:",sample$tel,"</p>"
                       )
